      ...
      <div style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.25rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{
              width: 36, height: 36,
              background: 'var(--gradient-accent, linear-gradient(135deg, #e85180, #f472b6))',
              borderRadius: 10,
              display: 'flex', alignItems: 'center', justifyContent: 'center',
            }}>
          ...
          <button onClick={onClose} style={{
            ...
            color: 'var(--gray-400, #9ca3af)', padding: 4, borderRadius: 6,
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          <div>
            ...
            <textarea
              ...
              placeholder="Contoh: Water, Niacinamide, Glycerin, Centella Asiatica"
              rows={3}
              style={{
            ...
            {result.rekomendasi_sistem && (
              <div>
                ...
                {result.rekomendasi_sistem.map((r, i) => (
                  <p key={i} style={{ margin: '0 0 4px', fontSize: '0.83rem', color: 'var(--gray-700, #374151)', lineHeight: 1.5 }}>• {r}</p>
                ))}
              </div>
            )}
          </div>
              ...
              {[
                ...
                onClick ? (
                  ...
                  <a key={label} href={href} style={{
                    display: 'flex', alignItems: 'center', gap: 8,
                    padding: '0.65rem 0.85rem',
                    border: isPrimary ? 'none' : '1.5px solid var(--pink-100)',
                    borderRadius: 'var(--radius-md)',
